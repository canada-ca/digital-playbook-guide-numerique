...
<p>1.1 Is the system making a discretionary decision?</p>
<ul>
<li data-wb-fieldflow='[{ "action": "append", "source": "#question-1-1-1" }, { "action": "removeClass", "source": "#question-1-1-1-result", "class": "hidden" }, { "action": "addClass", "source": "#question-1-2-result, .question-1-2-yes, .question-1-2-no", "class": "hidden" }, { "action": "removeClass", "source": ".question-1-1-yes", "class": "hidden" }]'>Yes</li>
<li data-wb-fieldflow='[{ "action": "append", "source": "#question-1-2" }, { "action": "removeClass", "source": "#question-1-2-result", "class": "hidden" }, { "action": "addClass", "source": "#question-1-1-1-result, .question-1-1-1-yes, .question-1-1-1-no", "class": "hidden" }, { "action": "removeClass", "source": ".question-1-1-no", "class": "hidden" }]'>No</li>
</ul>
</div>
</div>

<!-- Question 1.1.1 -->
<div id="question-1-1-1" class="hidden wb-fieldflow-sub" data-wb-fieldflow='{ "renderas": "radio", "inline": true, "default": [{ "action": "append", "source": "#question-1-2" }, { "action": "removeClass", "source": "#question-1-2-result", "class": "hidden" }, { "action": "addClass", "source": ".question-1-1-1-yes, .question-1-1-1-no", "class": "hidden" }] }'>
...
<!-- Question 1.2 -->
<div id="question-1-2" class="hidden wb-fieldflow-sub" data-wb-fieldflow='{ "renderas": "radio", "inline": true, "default": { "action": "addClass", "source": ".question-1-2-yes, .question-1-2-no", "class": "hidden" } }'>
<p>1.2 Is the system making a discretionary decision?</p>
<ul>
<li data-wb-fieldflow='{ "action": "removeClass", "source": ".question-1-2-yes", "class": "hidden" }'>Yes</li>
<li data-wb-fieldflow='{ "action": "removeClass", "source": ".question-1-2-no", "class": "hidden" }'>No</li>
</ul>
</div>
...
<p>2. Will this automated system result in the restriction of movement into, out of, or within Canada?</p>
<ul>
...
<p>3. Will this system infer or predict potential criminal activity?</p>
<ul>
...
<p>4. Will this system grant or restrict access to a premises or network?</p>
<ul>
...
<li data-wb-fieldflow='[{ "action": "addClass", "source": "#question-4-1-result", "class": "hidden" }, { "action": "removeClass", "source": ".question-4-no", "class": "hidden" }]'>No</li>
</ul>
</div>

<!-- Question 4.1 -->
<div id="question-4-1" class="hidden wb-fieldflow-sub" data-wb-fieldflow='{ "renderas": "radio", "inline": true, "default": { "action": "addClass", "source": ".question-4-1-yes, .question-4-1-no", "class": "hidden" } }'>
<p>4.1 Is this premises or network secured? (e.g., access to a customs controlled area)</p>
<ul>
<li data-wb-fieldflow='{ "action": "removeClass", "source": ".question-4-1-yes", "class": "hidden" }'>Yes</li>
<li data-wb-fieldflow='{ "action": "removeClass", "source": ".question-4-1-no", "class": "hidden" }'>No</li>
</ul>
</div>
...
<p>5. Will this system provide funds to an individual, business, or community?</p>
<ul>
...
<li data-wb-fieldflow='[{ "action": "addClass", "source": "#question-5-1-result", "class": "hidden" }, { "action": "removeClass", "source": ".question-5-no", "class": "hidden" }]'>No</li>
</ul>
</div>
...
<p>5.1 Is this funding for a scoail or economic support program?</p>
<ul>
<li data-wb-fieldflow='[{ "action": "append", "source": "#question-5-1-1" }, { "action": "removeClass", "source": "#question-5-1-1-result", "class": "hidden" }, { "action": "addClass", "source": "#question-5-2-result, .question-5-2-yes, .question-5-2-no", "class": "hidden" }, { "action": "removeClass", "source": ".question-5-1-yes", "class": "hidden" }]'>Yes</li>
...
<p>5.2 Will the system issue transfer payments?</p>
<ul>
...
<p>6. Will this system issue a fine, administrative monetary penalty, or a debt collection notice?</p>
<ul>
...
<p>7. Will this system issue a permit or license?</p>
<ul>
<li data-wb-fieldflow='[{ "action": "append", "source": "#question-7-1" }, { "action": "append", "source": "#question-7-2" }, { "action": "removeClass", "source": "#question-7-1-result, #question-7-2-result", "class": "hidden" }, { "action": "removeClass", "source": ".question-7-yes", "class": "hidden" }]'>Yes</li>
<li data-wb-fieldflow='[{ "action": "addClass", "source": "#question-7-1-result, #question-7-2-result", "class": "hidden" }, { "action": "removeClass", "source": ".question-7-no", "class": "hidden" }]'>No</li>
</ul>
</div>
...
<ul>
<li data-wb-fieldflow='{ "action": "removeClass", "source": ".question-7-1-yes", "class": "hidden" }'>Yes</li>
<li data-wb-fieldflow='{ "action": "removeClass", "source": ".question-7-1-no", "class": "hidden" }'>No</li>
</ul>
</div>
...
<p>8. Will this system confer a legal status that is otherwise required to receive a benefit or service (e.g., Indian status, veteran status)?</p>
<ul>
...
<p>9. Will this system categorize or profile an individual, business, community, or market segment in terms of risk?</p>
<ul>
...
<li data-wb-fieldflow='[{ "action": "addClass", "source": "#question-16-1-result", "class": "hidden" }, { "action": "removeClass", "source": ".question-16-no", "class": "hidden" }]'>No</li>
</ul>
</div>
...
<li data-wb-fieldflow='[{ "action": "addClass", "source": "#question-17-1-result, #question-17-2-result", "class": "hidden" }, { "action": "removeClass", "source": ".question-17-no", "class": "hidden" }]'>No</li>
</ul>
</div>
...
<p>17.2 Have you engaged Indigenous organizations in meaningful consultation in the design of the system?</a>?</p>
<ul>
...
<li data-wb-fieldflow='[{ "action": "addClass", "source": "#question-18-1-result, #question-18-2-result", "class": "hidden" }, { "action": "removeClass", "source": ".question-18-no", "class": "hidden" }]'>No</li>
</ul>
</div>
...
<li data-wb-fieldflow='[{ "action": "addClass", "source": "#question-20-1-result", "class": "hidden" }, { "action": "removeClass", "source": ".question-20-no", "class": "hidden" }]'>No</li>
</ul>
</div>
...
<!-- TODO: Cleanup still required -->
<!-- Question 13 -->
<fieldset>
<legend class="mrgn-bttm-0 h5 required" aria-required="true">13. Are you planning to make information about system functionality publicly available? <strong class="required" aria-required="true">(required)</strong></legend><span class="clearfix"></span>

<div id="question-13a" class="wb-fieldflow" data-wb-fieldflow='{ "renderas": "radio", "inline": true, "noForm": true, "base": { "live": true } }'>
...
<div id="question-13b" class="wb-fieldflow" data-wb-fieldflow='{ "renderas": "radio", "inline": true, "noForm": true, "base": { "live": true } }'>
...
<div id="question-13c" class="wb-fieldflow" data-wb-fieldflow='{ "renderas": "radio", "inline": true, "noForm": true, "base": { "live": true } }'>
...
<div id="question-13d" class="wb-fieldflow" data-wb-fieldflow='{ "renderas": "radio", "inline": true, "noForm": true, "base": { "live": true } }'>
...
<div id="question-13e" class="wb-fieldflow" data-wb-fieldflow='{ "renderas": "radio", "inline": true, "noForm": true, "base": { "live": true } }'>
<p>e. Criteria</p>
<ul>
<li data-wb-fieldflow=''>Yes</li>
<li data-wb-fieldflow=''>No</li>
...
<div id="question-13f" class="wb-fieldflow" data-wb-fieldflow='{ "renderas": "radio", "inline": true, "noForm": true, "base": { "live": true } }'>
...
<p>14. Have the system design and processes been reviewed by the appropriate Legal Services Unit and other legal experts, as required?</p>
<ul>
<li data-wb-fieldflow='[{ "action": "append", "source": "#question-14-1" }, { "action": "append", "source": "#question-14-2" }, { "action": "removeClass", "source": "#question-14-1-result", "class": "hidden" }, { "action": "removeClass", "source": "#question-14-2-result", "class": "hidden" }]'>Yes</li>
<li data-wb-fieldflow=''>No</li>
</ul>
</div>

<!-- Question 14.1 -->
<div id="question-14-1" class="hidden wb-fieldflow-sub" data-wb-fieldflow='{ "renderas": "radio", "inline": true }'>
<p>14.1 Has a formal opinion been issued?</p>
<ul>
<li data-wb-fieldflow=''>Yes</li>
<li data-wb-fieldflow=''>No</li>
</ul>
...
<!-- Question 14.2 -->
<div id="question-14-2" class="hidden wb-fieldflow-sub" data-wb-fieldflow='{ "renderas": "radio", "inline": true }'>
<p>14.2 Have the relevant areas of legislation been identified during the scoping phase?</p>
<ul>
<li data-wb-fieldflow=''>Yes</li>
<li data-wb-fieldflow=''>No</li>
</ul>
...
<p>15. Does the system require the exercise of discretion or judgment by an officer? (i.e., human in the loop)</p>
<ul>
<li data-wb-fieldflow='[{ "action": "append", "source": "#question-15-1" }, { "action": "append", "source": "#question-15-2" }, { "action": "removeClass", "source": "#question-15-1-result", "class": "hidden" }, { "action": "removeClass", "source": "#question-15-2-result", "class": "hidden" }]'>Yes</li>
<li data-wb-fieldflow=''>No</li>
</ul>
</div>

<!-- Question 15.1 -->
<div id="question-15-1" class="hidden wb-fieldflow-sub" data-wb-fieldflow='{ "renderas": "radio", "inline": true }'>
<p>15.1 Have all the decision points that involve the exercise of discretion or judgement been clearly identified as requiring human input?</p>
<ul>
<li data-wb-fieldflow=''>Yes</li>
<li data-wb-fieldflow=''>No</li>
</ul>
...
<!-- Question 15.2 -->
<div id="question-15-2" class="hidden wb-fieldflow-sub" data-wb-fieldflow='{ "renderas": "radio", "inline": true }'>
<p>15.2 Are the business rules relating to discretion or judgment contained in the automated system open to internal and external review?</p>
<ul>
<li data-wb-fieldflow=''>Yes</li>
<li data-wb-fieldflow=''>No</li>
</ul>
...
<p>16. Does the Automated Decision System require the us of personal information?</p>
<ul>
<li data-wb-fieldflow='[{ "action": "append", "source": "#question-16-1" }, { "action": "removeClass", "source": "#question-16-1-result", "class": "hidden" }]'>Yes</li>
<li data-wb-fieldflow=''>No</li>
</ul>
</div>

<!-- Question 16.1 -->
<div id="question-16-1" class="hidden wb-fieldflow-sub" data-wb-fieldflow='{ "renderas": "radio", "inline": true }'>
<p>16.1 Have you undertaken a Privacy Impact Assessment?</p>
<ul>
<li data-wb-fieldflow=''>Yes</li>
<li data-wb-fieldflow=''>No</li>
</ul>
...
<p>17. Have you conducted a Security Assessment and Authorization?</p>
<ul>
<li data-wb-fieldflow=''>Yes</li>
<li data-wb-fieldflow=''>No</li>
<li data-wb-fieldflow=''>Not applicable</li>
...
<p>18. Is there a process in place to monitor and grant access permission?</p>
<ul>
<li data-wb-fieldflow=''>Yes</li>
<li data-wb-fieldflow=''>No</li>
</ul>
...
<p>19. Does the system enable human override of system decisions?</p>
<ul>
<li data-wb-fieldflow=''>Yes</li>
<li data-wb-fieldflow=''>No</li>
</ul>
...
<p>20. Does the system enable override of human decisions?</p>
<ul>
<li data-wb-fieldflow=''>Yes</li>
<li data-wb-fieldflow=''>No</li>
</ul>
...
<!-- Question 21 -->
<div id="question-21" class="wb-fieldflow" data-wb-fieldflow='{ "renderas": "radio", "inline": true, "noForm": true, "base": { "live": true } }'>
<p>21. Does the system enable the override of other automated decision systems?</p>
<ul>
<li data-wb-fieldflow=''>Yes</li>
<li data-wb-fieldflow=''>No</li>
</ul>
...
<p>22. Do you have processes in place to log the instances where overrides were performed?</p>
<ul>
<li data-wb-fieldflow=''>Yes</li>
<li data-wb-fieldflow=''>No</li>
</ul>
...
<p>23. Do you have a process in place to test and verify business rules?</p>
<ul>
<li data-wb-fieldflow=''>Yes</li>
<li data-wb-fieldflow=''>No</li>
</ul>
...
<!-- Question 24 -->
<div id="question-24" class="wb-fieldflow" data-wb-fieldflow='{ "renderas": "radio", "inline": true, "noForm": true, "base": { "live": true } }'>
<p>24. Did you develop verification processes, for example testing for unintentional outcomes?</p>
<ul>
<li data-wb-fieldflow=''>Yes</li>
<li data-wb-fieldflow=''>No</li>
</ul>
...
<p>25. Did you develop a verification strategy to assess whether the system is being used as designed and intended?</p>
<ul>
<li data-wb-fieldflow=''>Yes</li>
<li data-wb-fieldflow=''>No</li>
</ul>
...
<p>26. Is the system used by a different part of the organization than the ones who developed it?</p>
<ul>
<li data-wb-fieldflow='[{ "action": "append", "source": "#question-26-1" }, { "action": "removeClass", "source": "#question-26-1-result", "class": "hidden" }]'>Yes</li>
<li data-wb-fieldflow=''>No</li>
</ul>
</div>

<!-- Question 26.1 -->
<div id="question-26-1" class="hidden wb-fieldflow-sub" data-wb-fieldflow='{ "renderas": "radio", "inline": true }'>
<p>26.1 Did you develop training programs to ensure that the system is used effectively and properly?</p>
<ul>
<li data-wb-fieldflow='[{ "action": "append", "source": "#question-26-1-1" }, { "action": "removeClass", "source": "#question-26-1-1-result", "class": "hidden" }]'>Yes</li>
<li data-wb-fieldflow=''>No</li>
</ul>
</div>

<!-- Question 26.1.1 -->
<div id="question-26-1-1" class="hidden wb-fieldflow-sub" data-wb-fieldflow='{ "renderas": "radio", "inline": true }'>
<p>26.1.1 Do you have mechanisms in place to ensure that training requirements are being met?</p>
<ul>
<li data-wb-fieldflow=''>Yes</li>
<li data-wb-fieldflow=''>No</li>
</ul>
...
<p>27. Can the system provide an audit trail that can monitor recommendations, decisions, and processes?</p>
<ul>
<li data-wb-fieldflow='[{ "action": "append", "source": "#question-27-1" }, { "action": "append", "source": "#question-27-2" }, { "action": "append", "source": "#question-27-3" }, { "action": "removeClass", "source": "#question-27-4", "class": "hidden" }, { "action": "append", "source": "#question-27-4a" }, { "action": "append", "source": "#question-27-4a" }, { "action": "append", "source": "#question-27-5" }, { "action": "removeClass", "source": "#question-27-1-result", "class": "hidden" }, { "action": "removeClass", "source": "#question-27-2-result", "class": "hidden" }, { "action": "removeClass", "source": "#question-27-3-result", "class": "hidden" }, { "action": "removeClass", "source": "#question-27-4a-result", "class": "hidden" }, { "action": "removeClass", "source": "#question-27-4b-result", "class": "hidden" }, { "action": "removeClass", "source": "#question-27-5-result", "class": "hidden" }]'>Yes</li>
<li data-wb-fieldflow=''>No</li>
</ul>
</div>

<!-- Question 27.1 -->
<div id="question-27-1" class="hidden wb-fieldflow-sub" data-wb-fieldflow='{ "renderas": "radio", "inline": true }'>
<p>27.1 Does the audit trail clearly set out all decision points made by the system?</p>
<ul>
<li data-wb-fieldflow=''>Yes</li>
<li data-wb-fieldflow=''>No</li>
</ul>
...
<!-- Question 27.2 -->
<div id="question-27-2" class="hidden wb-fieldflow-sub" data-wb-fieldflow='{ "renderas": "radio", "inline": true }'>
<p>27.2 Can the decisions made by the system be incorporated into a statement, reasons or other written notification, where required?</p>
<ul>
<li data-wb-fieldflow=''>Yes</li>
<li data-wb-fieldflow=''>No</li>
</ul>
...
<!-- Question 27.3 -->
<div id="question-27-3" class="hidden wb-fieldflow-sub" data-wb-fieldflow='{ "renderas": "radio", "inline": true }'>
<p>27.3 Have you designed the audit trail to include clearly identifiable links to: authorized delegations, including relevant legislation, policy or procedures?</p>
<ul>
<li data-wb-fieldflow=''>Yes</li>
<li data-wb-fieldflow=''>No</li>
</ul>
...
<!-- Question 27.4 -->
<fieldset class="hidden question-27-4">
<legend class="mrgn-bttm-0 h5 required" aria-required="true">27.4 Have you included change control processes in the audit trail to: <strong class="required" aria-required="true">(required)</strong></legend><span class="clearfix"></span>

<div id="question-27-4a" class="hidden wb-fieldflow-sub" data-wb-fieldflow='{ "renderas": "radio", "inline": true }'>
<p>a. Record modifications to the system's operation or performance</p>
<ul>
<li data-wb-fieldflow=''>Yes</li>
<li data-wb-fieldflow=''>No</li>
<li data-wb-fieldflow=''>Not applicable</li>
...
<div id="question-27-4b" class="hidden wb-fieldflow-sub" data-wb-fieldflow='{ "renderas": "radio", "inline": true }'>
<p>a. Reflect changes to the legislation that underpins the operation of the system</p>
<ul>
<li data-wb-fieldflow=''>Yes</li>
<li data-wb-fieldflow=''>No</li>
<li data-wb-fieldflow=''>Not applicable</li>
...
<!-- Question 27.5 -->
<div id="question-27-5" class="hidden wb-fieldflow-sub" data-wb-fieldflow='{ "renderas": "radio", "inline": true }'>
<p>27.5 Does the audit trail show who an authorized decision-maker is?</p>
<ul>
<li data-wb-fieldflow=''>Yes</li>
<li data-wb-fieldflow=''>No</li>
</ul>
...
<p>28. If the system is intended to undertake tasks currently undertaken by human staff, have you engaged your departmental human resources?</p>
<ul>
<li data-wb-fieldflow=''>Yes</li>
<li data-wb-fieldflow=''>No</li>
</ul>
...
<p>29. Have you developed a communications strategy to address any potential changes to work practices for officers?</p>
<ul>
<li data-wb-fieldflow=''>Yes</li>
<li data-wb-fieldflow=''>No</li>
</ul>
...
<p>30. Have you developed an external communications plan?</p>
<ul>
<li data-wb-fieldflow=''>Yes</li>
<li data-wb-fieldflow=''>No</li>
</ul>
...
<p>31. Have you established appropriate user/client feedback mechanisms?</p>
<ul>
<li data-wb-fieldflow=''>Yes</li>
<li data-wb-fieldflow=''>No</li>
</ul>
...
<th>1a</th>
<td><span class="hidden criteria-1-score criteria-1-score-max question-1a-yes">0</span><span class="criteria-1-score question-1a-no">0</span></td>
<td><span class="hidden criteria-2-score criteria-2-score-max question-1a-yes">0</span><span class="criteria-2-score question-1a-no">0</span></td>
...
<td><span class="hidden criteria-4-score criteria-4-score-max question-1a-yes">0</span><span class="criteria-4-score question-1a-no">0</span></td>
...
<th>1b</th>
<td><span class="hidden criteria-1-score criteria-1-score-max question-1b-yes">0</span><span class="criteria-1-score question-1b-no">0</span></td>
<td><span class="hidden criteria-2-score criteria-2-score-max question-1b-yes">0</span><span class="criteria-2-score question-1b-no">0</span></td>
...
<td><span class="hidden criteria-4-score criteria-4-score-max question-1b-yes">0</span><span class="criteria-4-score question-1b-no">0</span></td>
...
<th>1c</th>
<td><span class="hidden criteria-1-score criteria-1-score-max question-1c-yes">0</span><span class="criteria-1-score question-1c-no">0</span></td>
<td><span class="hidden criteria-2-score criteria-2-score-max question-1c-yes">0</span><span class="criteria-2-score question-1c-no">0</span></td>
...
<td><span class="hidden criteria-4-score criteria-4-score-max question-1c-yes">0</span><span class="criteria-4-score question-1c-no">0</span></td>
<td><span class="hidden criteria-5-score criteria-5-score-max question-1c-yes">0</span><span class="criteria-5-score question-1c-no">0</span></td>
</tr>
<tr id="question-1d-result" class="question-1-checkbox-score">
<th>1d</th>
<td><span class="hidden criteria-1-score criteria-1-score-max question-1d-yes">0</span><span class="criteria-1-score question-1d-no">0</span></td>
<td><span class="hidden criteria-2-score criteria-2-score-max question-1d-yes">0</span><span class="criteria-2-score question-1d-no">0</span></td>
...
<td><span class="hidden criteria-4-score criteria-4-score-max question-1d-yes">0</span><span class="criteria-4-score question-1d-no">0</span></td>
<td><span class="hidden criteria-5-score criteria-5-score-max question-1d-yes">0</span><span class="criteria-5-score question-1d-no">0</span></td>
</tr>
<tr id="question-1-1-result" class="hidden">
<th>1.1</th>
<td><span class="hidden criteria-1-score criteria-1-score-max question-1-1-yes">0</span><span class="hidden criteria-1-score question-1-1-no">0</span></td>
...
<td><span class="hidden criteria-4-score criteria-4-score-max question-1-1-yes">0</span><span class="hidden criteria-4-score question-1-1-no">0</span></td>
<td><span class="hidden criteria-5-score criteria-5-score-max question-1-1-yes">0</span><span class="hidden criteria-5-score question-1-1-no">0</span></td>
</tr>
<tr id="question-1-1-1-result" class="hidden">
<th>1.1.1</th>
<td><span class="hidden criteria-1-score criteria-1-score-max question-1-1-1-yes">0</span><span class="hidden criteria-1-score question-1-1-1-no">0</span></td>
...
<td><span class="hidden criteria-4-score criteria-4-score-max question-1-1-1-yes">0</span><span class="hidden criteria-4-score question-1-1-1-no">0</span></td>
<td><span class="hidden criteria-5-score criteria-5-score-max question-1-1-1-yes">0</span><span class="hidden criteria-5-score question-1-1-1-no">0</span></td>
</tr>
<tr id="question-1-2-result" class="hidden">
<th>1.2</th>
<td><span class="hidden criteria-1-score criteria-1-score-max question-1-2-yes">0</span><span class="hidden criteria-1-score question-1-2-no">0</span></td>
<td><span class="hidden criteria-2-score criteria-2-score-max question-1-2-yes">0</span><span class="hidden criteria-2-score question-1-2-no">0</span></td>
<td><span class="hidden criteria-3-score criteria-3-score-max question-1-2-yes">0</span><span class="hidden criteria-3-score question-1-2-no">0</span></td>
<td><span class="hidden criteria-4-score criteria-4-score-max question-1-2-yes">0</span><span class="hidden criteria-4-score question-1-2-no">0</span></td>
<td><span class="hidden criteria-5-score criteria-5-score-max question-1-2-yes">0</span><span class="hidden criteria-5-score question-1-2-no">0</span></td>
</tr>
<tr>
...
<th>4</th>
<td><span class="hidden criteria-1-score criteria-1-score-max question-4-yes">2</span><span class="hidden criteria-1-score question-4-no">0</span></td>
<td><span class="hidden criteria-2-score criteria-2-score-max question-4-yes">4</span><span class="hidden criteria-2-score question-4-no">0</span></td>
...
<th>4.1</th>
<td><span class="hidden criteria-1-score criteria-1-score-max question-4-1-yes">0</span><span class="hidden criteria-1-score question-4-1-no">0</span></td>
<td><span class="hidden criteria-2-score criteria-2-score-max question-4-1-yes">0</span><span class="hidden criteria-2-score question-4-1-no">0</span></td>
<td><span class="hidden criteria-3-score criteria-3-score-max question-4-1-yes">0</span><span class="hidden criteria-3-score question-4-1-no">0</span></td>
<td><span class="hidden criteria-4-score criteria-4-score-max question-4-1-yes">0</span><span class="hidden criteria-4-score question-4-1-no">0</span></td>
<td><span class="hidden criteria-5-score criteria-5-score-max question-4-1-yes">0</span><span class="hidden criteria-5-score question-4-1-no">0</span></td>
</tr>
...
<th>5.1.1</th>
<td><span class="hidden criteria-1-score criteria-1-score-max question-5-1-1-yes">0</span><span class="hidden criteria-1-score question-5-1-1-no">0</span></td>
...
<td><span class="hidden criteria-4-score criteria-4-score-max question-5-1-1-yes">0</span><span class="hidden criteria-4-score question-5-1-1-no">0</span></td>
...
<td><span class="hidden criteria-2-score criteria-2-score-max question-5-2-yes">0</span><span class="hidden criteria-2-score question-5-2-no">0</span></td>
...
<th>5.2.1</th>
<td><span class="hidden criteria-1-score criteria-1-score-max question-5-2-1-yes">0</span><span class="hidden criteria-1-score question-5-2-1-no">0</span></td>
<td><span class="hidden criteria-2-score criteria-2-score-max question-5-2-1-yes">0</span><span class="hidden criteria-2-score question-5-2-1-no">0</span></td>
...
<th>7</th>
<td><span class="hidden criteria-1-score criteria-1-score-max question-7-yes">3</span><span class="hidden criteria-1-score question-7-no">0</span></td>
<td><span class="hidden criteria-2-score criteria-2-score-max question-7-yes">3</span><span class="hidden criteria-2-score question-7-no">0</span></td>
...
<th>7.1</th>
<td><span class="hidden criteria-1-score criteria-1-score-max question-7-1-yes">0</span><span class="hidden criteria-1-score question-7-1-no">0</span></td>
<td><span class="hidden criteria-2-score criteria-2-score-max question-7-1-yes">0</span><span class="hidden criteria-2-score question-7-1-no">0</span></td>
...
<th>7.2</th>
<td><span class="hidden criteria-1-score criteria-1-score-max question-7-2-yes">0</span><span class="hidden criteria-1-score question-7-2-no">0</span></td>
<td><span class="hidden criteria-2-score criteria-2-score-max question-7-2-yes">0</span><span class="hidden criteria-2-score question-7-2-no">0</span></td>
...
<td><span class="hidden criteria-2-score criteria-2-score-max question-8-yes">3</span><span class="hidden criteria-2-score question-8-no">0</span></td>
...
<td><span class="hidden criteria-1-score criteria-1-score-max question-9-yes">4</span><span class="hidden criteria-1-score question-9-no">0</span></td>
...
<td><span class="hidden criteria-3-score question-11-yes">0</span><span class="hidden criteria-3-score criteria-3-score-max question-11-no">0</span></td>
...
<th>16.1</th>
<td><span class="hidden criteria-1-score question-16-1-yes">0</span><span class="hidden criteria-1-score criteria-1-score-max question-16-1-no">0</span><span class="hidden criteria-1-score question-16-1-na">0</span></td>
...
<td><span class="hidden criteria-3-score question-16-1-yes">0</span><span class="hidden criteria-3-score criteria-3-score-max question-16-1-no">0</span><span class="hidden criteria-3-score question-16-1-na">0</span></td>
