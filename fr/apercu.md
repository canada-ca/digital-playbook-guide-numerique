...
{% include /functions/standard-links.html samePage=false listClasses="colcount-sm-2 list-unstyled dpgn-data-ignore" linkClasses="btn btn-default btn-lg mrgn-bttm-md" subLinkClasses="btn-block text-left" %}
