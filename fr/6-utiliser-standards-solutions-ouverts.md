...
- Utilisez un langage familier et un design simple tout au long du service, y compris des points de contact en ligne et hors ligne , en assurant une conception cohérente à travers services numériques connexes **(critères de conception de produits OneGC)**

- Donner aux utilisateurs des informations claires sur l'endroit où ils se trouvent à chaque étape du processus **(critères de conception du produit OneGC)**
...
- Agilité: Un accès rapide est disponible pour les ressources informatiques multi-fonctions à la capacité requise pour mener à bien les projets de la planification à l'exploitation complète.
