...
[5.1 Rendre toutes les données et informations non sensibles ouvertes au monde extérieur pour les partager et les réutiliser sous une licence ouverte](5-travailler-air-libre-par-defaut.md#user-content-51-rendre-toutes-les-donn%C3%A9es-et-informations-non-sensibles-ouvertes-au-monde-ext%C3%A9rieur-pour-les-partager-et-les-r%C3%A9utiliser-sous-une-licence-ouverte)
...
[6.4 Ouvrez les données, les transactions et les règles métier qui sous-tendent un service](6-utiliser-standards-solutions-ouverts.md#user-content-64-ouvrez-les-donn%C3%A9es-les-transactions-et-les-r%C3%A8gles-m%C3%A9tier-qui-sous-tendent-un-service)
